...
* [Groundwork](implementation/README.md)
  ...
  * [Domain driven Lambdas with a use case approach](implementation/domain-driven-lambdas-with-a-use-case-approach.md)
    ...
    * [Reserve a slot](implementation/cloud-architecture/book-a-slot.md)
    * [Check in](implementation/cloud-architecture/check-in.md)
    * [Check out](implementation/cloud-architecture/check-out.md)
    * [Cancel a slot](implementation/cloud-architecture/cancel-a-room-reservation.md)
    * [Unattend no-shows](implementation/cloud-architecture/verify-check-ins.md)
