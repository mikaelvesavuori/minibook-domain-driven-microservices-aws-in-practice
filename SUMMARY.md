...
* [Groundwork](implementation/README.md)
  ...
  * [Deciding on a Cloud Architecture](implementation/cloud-architecture.md)
  * [Technical boilerplating](implementation/technical-boilerplating.md)
  * [Domain driven Lambdas with a use case approach](implementation/domain-driven-lambdas-with-a-use-case-approach/README.md)
    * [List slots](implementation/domain-driven-lambdas-with-a-use-case-approach/list-slots.md)
    * [Book a slot](implementation/domain-driven-lambdas-with-a-use-case-approach/book-a-slot.md)
    * [Check in](implementation/domain-driven-lambdas-with-a-use-case-approach/check-in.md)
    * [Check out](implementation/domain-driven-lambdas-with-a-use-case-approach/check-out.md)
    * [Cancel a room reservation](implementation/domain-driven-lambdas-with-a-use-case-approach/cancel-a-room-reservation.md)
    * [Verify check-ins](implementation/domain-driven-lambdas-with-a-use-case-approach/verify-check-ins.md)
