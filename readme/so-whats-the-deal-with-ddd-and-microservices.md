...
# DDD and microservices go well together
...
Principles and broad patterns simply don't age as much as (most) languages and pretty much anything that is only implementation-oriented. It's safe to say that DDD and its patterns have survived many changes in technology without losing its relevance, though absolutely there are popping up other approaches to compete with DDD.
...
Let's look at some reasonable objections.
